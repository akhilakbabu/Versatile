object Teachersfreedlg: TTeachersfreedlg
  Left = 199
  Top = 155
  HelpContext = 184
  BorderStyle = bsDialog
  Caption = 'Teachers Free Selection'
  ClientHeight = 341
  ClientWidth = 474
  Color = clBtnFace
  ...
  object GroupBox2: TGroupBox
    ...
    object ListBox1: TListBox
      ...
      Width = 105
      Height = 221
      Hint = 'Click to select teacher codes'
      ItemHeight = 13
      Items.Strings = (
        'WWWWWWWW'
        'WWWWWWWW')
    ...
    object GroupBox1: TGroupBox
      ...
      object Panel1: TPanel
        ...
        object RadioButton7: TRadioButton
          ...
          Width = 71
          Height = 13
          Hint = 'Use list boxes to select teachers'
          Caption = '&Selection'
          TabOrder = 1
        ...
        object chbMatchAllYears: TCheckBox
          Left = 8
          Top = 93
          Width = 105
          Height = 13
      ...
      object RadioButton1: TRadioButton
        ...
        Width = 80
        Height = 13
        Hint = 'Teachers free for each time slot'
        Caption = '&Time Slot'
        TabOrder = 0
      ...
      object RadioButton2: TRadioButton
        ...
        Width = 78
        Height = 13
        Hint = 'Teachers free by the number of free times'
        Caption = '&Frees'
        Checked = True
        TabOrder = 1
        TabStop = True
      ...
      object RadioButton3: TRadioButton
        ...
        Width = 79
        Height = 13
        Hint = 'Teachers free map for each teacher'
        Caption = 'T&eacher:'
        TabOrder = 2
    ...
    object UpBtn: TBitBtn
      ...
      Width = 30
      Height = 24
      Hint = 'Move selected teachers up'
      ParentShowHint = False
      ShowHint = True
      TabOrder = 10
      OnClick = UpBtnClick
    ...
    object DnBtn: TBitBtn
      ...
      Width = 30
      Height = 24
      Hint = 'Move selected teachers down'
      ParentShowHint = False
      ShowHint = True
      TabOrder = 11
      OnClick = DnBtnClick
  ...
  object OKbutton: TBitBtn
    ...
    Width = 75
    Height = 25
    Hint = 'Show Teachers Free window'
